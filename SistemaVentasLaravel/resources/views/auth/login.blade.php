                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-4" style="margin-top: -20px">
                                            <div class="text-danger small">Incorrecto Usuario o Contraseña.</div>
                                        </div>
                                        @enderror
                                        @error('email')
                                        <div class="mb-4" style="margin-top: -20px">
                                            <div class="text-danger small">Incorrect Usuario o Contraseña.</div>
                                        </div>
                                        @enderror
                                    </div>
                                    <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6">
                                        <p>
                                            Todavía no tienes una cuenta? <a href="{{ route('register') }}" class="text-primary">Registrarse</a>
                                        </p>
                                    </div>
                                    <div class="col-lg-6">
